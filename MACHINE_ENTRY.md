...
- not the normative core
- not the executable implementation layer
- not a replacement for AGI framing, SER continuity, or ERB constraints
...
- This repo is a narrative companion, not the normative core.
...
- Companion illumination does not outrank stronger doctrinal, evidence, or control surfaces.
- Companion context may have stable artifact identity without becoming normative primary.
- Imported book assets remain preserved as imported.
- Provisional bundles remain documented rather than silently normalized.
- All Rights Reserved remains the governing rights posture.
